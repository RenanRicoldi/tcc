...
write_rides(count, 'by-station-per-hour/non-private-counts')
...
for p in levels_of_privacy:
  ...
  write_rides(private_count, 'by-station-per-hour/local-private-counts-epsilon-{:.3f}'.format(unary_epsilon(p, q)))